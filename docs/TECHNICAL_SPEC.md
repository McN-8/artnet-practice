...
1. Continue the browser player target: define a whole-state image/audio readiness policy, audio unlock and mixing policy, complete renderer visual/accessibility coverage, and add hold/double-tap arbitration plus responsive reader-control styling and lifecycle integration against the established input contracts.
